...
<form class="row g-3" id="formulario" method="POST" action="redireccion.php?action=home">
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="inputCodigo" name="contraseña" value="<?php echo $val[1]['COD_SUC']; ?>" readonly >
  </div>
  <div class="col-md-6">
    <label for="inputNombre" class="form-label">Nombre Sucursal</label>
    <input type="text" class="form-control" id="inputNombre" name="usuario" requiered value="<?php echo $val[1]['NOM_SUC']; ?>" readonly>
  </div>
  <div class="col-12">
    <label for="inputDireccion" class="form-label">Direccion Sucursal</label>
    <input type="text" class="form-control" id="inputDireccion" name="inputDireccion"  requiered value="<?php echo $val[1]['DIR_SUC']; ?>" disabled>
  </div>
  <div class="col-md-6">
    <label for="inputTelefono" class="form-label">Telefono Sucursal</label>
    <input type="text" class="form-control" id="inputTelefono" name="inputTelefono" requiered  value="<?php echo $val[1]['TEL_SUC']; ?>" disabled>
  </div>
  <div class="col-md-6">
    <label for="inputCiudad" class="form-label">Ciudad Sucursal</label>
    <input type="text" class="form-control" id="inputCiudad" name="inputCiudad" requiered value="<?php echo $val[1]['CIU_SUC']; ?>" disabled>
